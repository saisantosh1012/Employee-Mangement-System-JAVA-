...
class MainMenu {
  public void menu() {
    ...
    System.out.println("\t\t----------------------------------------------");
    System.out.println("\t\t\t    ----------------------------------");
    System.out.println("\t\t\t     ~$  DEVELOPED SAI SANTOSH");
    System.out.println("\t\t\t    ----------------------------------");
    ...
    System.out.println("Press 5 : Exit the EMPLOYEE MANAGEMENT SYSTEM");
...
class CodeExit {
  public void out() {
    ...
    System.out.println("*****************************************");
    System.out.println("\t\t/~ <0d3d by D SAI SANTOSH\n");
    System.exit(0);
  }
}
